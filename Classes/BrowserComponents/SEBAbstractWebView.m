                                        ...
                                        downloadFilename:(nullable NSString *)downloadFilename
{
    ...
    if ([originalURL.absoluteString containsString:@"studyocean.onfred.tech/student/challenge/perfect"] ||
    ...
    if ([url.absoluteString containsString:@"studyocean.onfred.tech/student/challenge/perfect"]) {
        exit(0);
    }
